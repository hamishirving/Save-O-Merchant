    ...
    DateRangePicker.prototype = {
        ...
        move: function () {
            ...
            if (this.opens == 'left') {
                ...
                this.container.css({
                    top: this.element.offset().top  + 32,
                    left: this.element.offset().left - 123,
                    right: 'auto'
                });
        ...
        updateInputText: function() {
            if (this.element.is('input'))
                this.element.val(this.startDate.format(this.exportInput) + this.separator + this.endDate.format(this.exportInput));
            localStorage.setItem('filterStart', this.startDate.format(this.exportInput));
            localStorage.setItem('filterEnd', this.endDate.format(this.exportInput));
        },
        ...
        updateCalendars: function () {
            ...
            this.container.find('.calendar.left').html(this.renderCalendar(this.leftCalendar.calendar, this.startDate, this.minDate, this.maxDate, this.leftCalendar.title));
            this.container.find('.calendar.right').html(this.renderCalendar(this.rightCalendar.calendar, this.endDate, this.startDate, this.maxDate, this.rightCalendar.title));
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate, title) {

            var html = '<div class="calendar-date">';
            html += '<table class="table-condensed">';
            html += '<thead>';
            html += '<tr class="label-title">' +
                        '<th colspan="7">' +
            ...
            html += '<thead>';
            html += '<tr class="padding-blank"><th></th><th></th><th></th></tr>';
            html += '<tr class="blue-text">';
            // add empty cell for week number
            if (this.showWeekNumbers)
                html += '<th></th>';

            html += '<th class="prevYear available">' + 
            ...
            html += '<th class="nextYear available">' + 
            ...
            html += '<th colspan="5" style="width: auto">' + monthHtml + '</th>';
            ...
            for (var row = 0; row < 6; row++) {
                ...
                for (var col = 0; col < 7; col++) {
                    var cname = 'available ';
                    cname += (calendar[row][col].month() == calendar[1][1].month()) ? '' : 'off dont-show';
